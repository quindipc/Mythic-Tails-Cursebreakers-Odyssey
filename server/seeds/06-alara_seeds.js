  ...
  return knex("alara_scenarios")
      ...
      return knex("alara_scenarios").insert([
        {
          ...
          alara_additional_story:"'Guardian,' Elowen whispers in a faint voice, 'the heart of the forest withers, and my brethren suffer. Only a special healing flower, the Radiant Bloom, hidden within the dangerous ruins of the forgotten temple, can mend our home. Please, save us'",
          alara_story: "Alara learns of the Radiant Bloom, the only flower with the power to break the curse and restore the heart of the forest. The flower is said to be hidden deep within the treacherous ruins of the forgotten temple.",
        },
        {
          alara_scenario_id: 2,
          alara_name: "Trials of the Forgotten Temple",
          alara_additional_story:"Filled with determination, Alara decides to embark on a perilous journey to find the Radiant Bloom. Along the way, she faces various challenges and encounters both allies and foes. The temple's ancient traps and guardians test her resolve, and she must call upon her skills as a guardian to overcome these obstacles.",
          alara_story: "Alara enters the forgotten temple, where she encounters various trials and puzzles designed to test the worthiness of those who seek the Radiant Bloom.",
        },
        {
          alara_scenario_id: 3,
          alara_name: "The Guidance of Creatures",
          alara_additional_story:"Feeling cautious about venturing into the dangerous temple, Alara decides to seek alternative solutions or gather more information before proceeding. She consults with the Spirit of Balance and other creatures in the forest to gain insights into the temple's dangers and potential clues to the Radiant Bloom's whereabouts.",
          alara_story: "Alara seeks guidance from the creatures of the forest, hoping they hold clues about the Radiant Bloom's location.",
        },
        {
          alara_scenario_id: 4,
          alara_name: "The Guardian's Trial",
          alara_additional_story:"Drawn to the temple's mysteries, Alara embraces the challenges and presses forward. Each trial she conquers reveals more about her own strength and the connection she shares with the Spirit of Balance.",
          alara_story: "In the heart of the temple, Alara faces the ultimate guardian, an ancient and powerful entity protecting the Radiant Bloom.",
        },
        {
          alara_scenario_id: 5,
          alara_name: "The Temptation of Darkness",
          alara_additional_story:"Overwhelmed by the trials and doubting her abilities, Alara contemplates retreating from the temple. However, a glimmer of hope remains, reminding her of the power that awaits should she succeed.",
          alara_story: "As Alara ventures deeper into the temple, she encounters dark energies that attempt to sway her from her path.",
        },
        {
          alara_scenario_id: 6,
          alara_name: "Creatures' Insights",
          alara_additional_story:"Recognizing the importance of cooperation, Alara forms an alliance with the creatures of the forest. They provide her with valuable insights and accompany her on her journey, strengthening her connection to the natural world.",
          alara_story: "Alara's alliance with the forest creatures proves valuable as they provide her with insights into the temple's trials and the guardian's weaknesses.",
        },
        {
          alara_scenario_id: 7,
          alara_name: "The Temple's Mysteries",
          alara_additional_story:"Preferring to rely on her own skills and instincts, Alara decides to face the challenges alone. She trusts her training as a guardian and remains determined to find the Radiant Bloom on her own.",
          alara_story: "Alara's journey through the temple leads her to discover ancient texts and relics that hold secrets about the Radiant Bloom and the curse.",
        },
        {
          alara_scenario_id: 8,
          alara_name: "The Burden of Choice",
          alara_additional_story:"With unwavering resolve, Alara resists the temptation of darkness and remains steadfast in her mission to find the Radiant Bloom. The Spirit of Balance's guidance strengthens her resolve as she pushes forward.",
          alara_story: "Alara faces a pivotal moment where her choices determine the outcome of her quest and the fate of Ethoria.",
        },
        {
          alara_scenario_id: 9,
          alara_name: "Ethical Dilemmas",
          alara_additional_story:"While the alliance with the creatures has been beneficial, Alara encounters a challenge that tests the trust between them. She must navigate the complexities of her relationships while continuing her quest for the Radiant Bloom.",
          alara_story: "Alara encounters situations that present ethical dilemmas, testing her commitment to balance and compassion.",
        },
        {
          alara_scenario_id: 10,
          alara_name: "Confrontation",
          alara_additional_story:"Intrigued by the temple's mysteries, Alara decides to delve deeper, uncovering secrets that shed light on the curse's origin and the potential consequences of breaking it.",
          alara_story: "After navigating through the temple and discovering the Radiant Bloom's location, Alara faces a confrontation with Aveline, the sorceress responsible for the cursed realm.",
        },
      ]);
    })
    .then(function () {
      ...
      // Scenario 1: The Healing Flower's Quest
        {
          alara_choice_id: 1,
          alara_description: "Embark on a perilous journey to find the Radiant Bloom.",
          alara_linked_scenario_id: 2,
          alara_linked_ending_id: null,
        },
        {
          alara_choice_id: 2,
          alara_description: "Seek an alternative solution or gather more information before proceeding.",
        ...
        {
          alara_choice_id: 3,
          alara_description: "Embrace the challenges of the temple and press forward.",
          alara_linked_scenario_id: 4,
          alara_linked_ending_id: null,
        },
        {
          alara_choice_id: 4,
          alara_description: "Doubt her abilities and consider turning back from the temple.",
        ...
        {
          alara_choice_id: 5,
          alara_description: "Form an alliance with the creatures and seek their aid.",
        ...
        //Scenario 4: The Guardian's Trial
        {
          ...
          alara_linked_scenario_id: null,
          alara_linked_ending_id: 1,
        },
        {
          alara_choice_id: 8,
          alara_description: "Outsmart the guardian through cunning and strategy",
          alara_linked_scenario_id: null,
        ...
        {
          alara_choice_id: 9,
          alara_description: "Resist the temptation and remain steadfast in her mission.",
          alara_linked_scenario_id: 8,
          alara_linked_ending_id: null,
        },
        {
          alara_choice_id: 10,
          alara_description: "Succumb to the temptation and face the consequences.",
          alara_linked_scenario_id: null,
        ...
        {
          alara_choice_id: 11,
          alara_description: "Utilize the creatures' insights to overcome the temple's challenges.",
          alara_linked_scenario_id: 4,
          alara_linked_ending_id: null,
        },
        {
          alara_choice_id: 12,
          alara_description: "Encounter a challenge that tests the alliance's trust.",
        ...
        {
          alara_choice_id: 13,
          alara_description: "Delve deeper into the temple's mysteries and learn its secrets.",
          alara_linked_scenario_id: 10,
          alara_linked_ending_id: null,
        },
        {
          alara_choice_id: 14,
          alara_description: "Choose not to dwell on the past and focus on the task at hand.",
          alara_linked_scenario_id: null,
        ...
        {
          alara_choice_id: 15,
          alara_description: "Embrace the weight of her responsibilities and decide to break the curse.",
          alara_linked_scenario_id: null,
          alara_linked_ending_id: 4,
        },
        {
          alara_choice_id: 16,
          alara_description: " Contemplate the consequences of her actions and seek another solution.",
          alara_linked_scenario_id: null,
        ...
        {
          alara_choice_id: 17,
          alara_description: "Prioritize compassion and find a peaceful resolution.",
          alara_linked_scenario_id: null,
          alara_linked_ending_id: 6,
        },
        {
          alara_choice_id: 18,
          alara_description: "Choose the path of pragmatism and make difficult sacrifices.",
          alara_linked_scenario_id: null,
        ...
        {
          alara_choice_id: 19,
          alara_description: "Confront Aveline directly, seeking answers and confrontation",
          alara_linked_scenario_id: null,
          alara_linked_ending_id: 8,
        },
        {
          alara_choice_id: 20,
          alara_description: "Avoid direct confrontation and observe Aveline from the shadows.",
          alara_linked_scenario_id: null,
    ...
    .then(function () {
      ...
      return knex("choices_scenarios").insert([
        // Scenario 1 choices
        { alara_scenario_id: 1, alara_choice_id: 1 },
        { alara_scenario_id: 1, alara_choice_id: 2 },
        // Scenario 2 choices
        { alara_scenario_id: 2, alara_choice_id: 3 },
        { alara_scenario_id: 2, alara_choice_id: 4 },
        // Scenario 3 choices
        { alara_scenario_id: 3, alara_choice_id: 5 },
        { alara_scenario_id: 3, alara_choice_id: 6 },
        // Scenario 4 choices
        { alara_scenario_id: 4, alara_choice_id: 7 },
        { alara_scenario_id: 4, alara_choice_id: 8 },
        // Scenario 5 choices
        { alara_scenario_id: 5, alara_choice_id: 9 },
        { alara_scenario_id: 5, alara_choice_id: 10 },
        // Scenario 6 choices
        { alara_scenario_id: 6, alara_choice_id: 11 },
        { alara_scenario_id: 6, alara_choice_id: 12 },
        // Scenario 7 choices
        { alara_scenario_id: 7, alara_choice_id: 13 },
        { alara_scenario_id: 7, alara_choice_id: 14 },
        // Scenario 8 choices
        { alara_scenario_id: 8, alara_choice_id: 15 },
        { alara_scenario_id: 8, alara_choice_id: 15 },
        // Scenario 9 choices
        { alara_scenario_id: 9, alara_choice_id: 17 },
        { alara_scenario_id: 9, alara_choice_id: 18 },
        // Scenario 10 choices
        { alara_scenario_id: 10, alara_choice_id: 19 },
        { alara_scenario_id: 10, alara_choice_id: 20 },
      ]);
    })
    .then(function () {
      ...
      return knex("choices_endings").insert([
        ...
        { alara_choice_id: 1, alara_ending_id: null },
        { alara_choice_id: 2, alara_ending_id: null },
        // Scenario 2 choices linked to endings
        { alara_choice_id: 3, alara_ending_id: null },
        { alara_choice_id: 4, alara_ending_id: null },
        // Scenario 3 choices linked to endings
        { alara_choice_id: 5, alara_ending_id: null },
        { alara_choice_id: 6, alara_ending_id: null },
        // Scenario 4 choices linked to endings
        { alara_choice_id: 7, alara_ending_id: 1 },
        { alara_choice_id: 8, alara_ending_id: 2 },
        // Scenario 5 choices linked to endings
        { alara_choice_id: 9, alara_ending_id: null },
        { alara_choice_id: 10, alara_ending_id: 3 },
        // Scenario 6 choices linked to endings
        { alara_choice_id: 11, alara_ending_id: null },
        { alara_choice_id: 12, alara_ending_id: null },
        // Scenario 7 choices linked to endings
        { alara_choice_id: 13, alara_ending_id: null },
        { alara_choice_id: 14, alara_ending_id: null },
        // Scenario 8 choices linked to endings
        { alara_choice_id: 15, alara_ending_id: 4 },
        { alara_choice_id: 16, alara_ending_id: 5 },
        // Scenario 9 choices linked to endings
        { alara_choice_id: 17, alara_ending_id: 6 },
        { alara_choice_id: 18, alara_ending_id: 7 },
        // Scenario 10 choices linked to endings
        { alara_choice_id: 19, alara_ending_id: 8 },
        { alara_choice_id: 20, alara_ending_id: 9 },
      ]);
    });
};
