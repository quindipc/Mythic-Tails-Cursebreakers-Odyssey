  ...
  return knex("nyx_scenarios")
    ...
    .then(() =>
      ...
      // Scenario 1: The Cursed Creature's Plea
        ...
        {
          nyx_choice_id: 12,
          nyx_description: "Succumb to doubt and consider abandoning the quest.",
          nyx_linked_scenario_id: 7,
          nyx_linked_ending_id: null,
        },
//Scenario 7: Clash of Paths
    ...
    .then(() =>
      ...
      knex("choices_scenarios").insert([
        // Scenario 1 choices
        { nyx_scenario_id: 1, nyx_choice_id: 1 },
        { nyx_scenario_id: 1, nyx_choice_id: 2 },
        // Scenario 2 choices
        { nyx_scenario_id: 2, nyx_choice_id: 3 },
        { nyx_scenario_id: 2, nyx_choice_id: 4 },
        // Scenario 3 choices
        { nyx_scenario_id: 3, nyx_choice_id: 5 },
        { nyx_scenario_id: 3, nyx_choice_id: 6 },
        // Scenario 4 choices
        { nyx_scenario_id: 4, nyx_choice_id: 7 },
        { nyx_scenario_id: 4, nyx_choice_id: 8 },
        // Scenario 5 choices
        { nyx_scenario_id: 5, nyx_choice_id: 9 },
        { nyx_scenario_id: 5, nyx_choice_id: 10 },
        // Scenario 6 choices
        { nyx_scenario_id: 6, nyx_choice_id: 11 },
        { nyx_scenario_id: 6, nyx_choice_id: 12 },
        // Scenario 7 choices
        { nyx_scenario_id: 7, nyx_choice_id: 13 },
        { nyx_scenario_id: 7, nyx_choice_id: 14 },
        // Scenario 8 choices
        { nyx_scenario_id: 8, nyx_choice_id: 15 },
        { nyx_scenario_id: 8, nyx_choice_id: 16 },
        // Scenario 9 choices
        { nyx_scenario_id: 9, nyx_choice_id: 17 },
        { nyx_scenario_id: 9, nyx_choice_id: 18 },
        // Scenario 10 choices
        { nyx_scenario_id: 10, nyx_choice_id: 19 },
        { nyx_scenario_id: 10, nyx_choice_id: 20 },
      ]),
    )
    .then(() =>
      ...
      knex("choices_endings").insert([
        // Scenario 1 choices
        { nyx_choice_id: 1, nyx_ending_id: 1 },
        { nyx_choice_id: 2, nyx_ending_id: null },
        // Scenario 2 choices
        { nyx_choice_id: 3, nyx_ending_id: null },
        { nyx_choice_id: 4, nyx_ending_id: null },
        // Scenario 3 choices
        { nyx_choice_id: 5, nyx_ending_id: 2 },
        { nyx_choice_id: 6, nyx_ending_id: null },
        // Scenario 4 choices
        { nyx_choice_id: 7, nyx_ending_id: null },
        { nyx_choice_id: 8, nyx_ending_id: null },
        // Scenario 5 choices
        { nyx_choice_id: 9, nyx_ending_id: null },
        { nyx_choice_id: 10, nyx_ending_id: null },
        // Scenario 6 choices
        { nyx_choice_id: 11, nyx_ending_id: 3 },
        { nyx_choice_id: 12, nyx_ending_id: null },
        // Scenario 7 choices
        { nyx_choice_id: 13, nyx_ending_id: 4 },
        { nyx_choice_id: 14, nyx_ending_id: null },
        // Scenario 8 choices
        { nyx_choice_id: 15, nyx_ending_id: null },
        { nyx_choice_id: 16, nyx_ending_id: 5 },
        // Scenario 9 choices
        { nyx_choice_id: 17, nyx_ending_id: null },
        { nyx_choice_id: 18, nyx_ending_id: 6 },
        // Scenario 10 choices
        { nyx_choice_id: 19, nyx_ending_id: 7 },
        { nyx_choice_id: 20, nyx_ending_id: 8 },
      ]),
    );
};
