...
export default function GameStart({ handleStartGame, onCharacterSelect }) {
        ...
        {!chosenCharacter && (
          <>
            <div className="gamestart__character">
              <h1 className="gamestart__character-name">Nyx, The Lost Cursebearer</h1>
            ...
            <div className="gamestart__character">
              <h1 className="gamestart__character-name">Alara, The Cursed Guardian</h1>
              <p className="gamestart__character-description">
